...
import { IHederaClient } from 'interfaces/smart-contracts/Hedera.interface';

// Configure accounts and client

export const getHederaClient = (): IHederaClient => {
...
const hedera = getHederaClient();
export default hedera;

// Sample Hedera Invocation Code
